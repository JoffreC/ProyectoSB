    ...
    <section class="header-nav border-black">
      <nav class="bg-black">
        <ul class="nav-container">
          <li><a href="GestionarLibroController?ruta=formLibro">Registrar Libro</a></li>
          <li><a href="">Buscar Libro</a></li>
          <li><a href="">Actualizar Libro</a></li>
          <li><a href="GestionarLibroController?ruta=formDeleteLibro">Eliminar Libro</a></li>
